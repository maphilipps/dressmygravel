...
- **Main File**: dressmyrun.js - 2.1MB minified bundle (436 lines)
- **Core Mechanic**: Production web application for dressmyrun.com
- **Key Integration**: Sentry error tracking, React runtime
- **Platform Support**: Web browsers (production deployment)
- **DO NOT**: Edit minified JavaScript directly - source code needed
...
## Quick Reference
**Production Bundle**: `dressmyrun.js:1-436` - Minified application bundle
...
## Current State
- [x] Production build present (minified)
- [ ] Source code unavailable
- [ ] Development environment needed
- [ ] Project requires source recovery or recreation

## Development Workflow
1. Locate original source code repository
2. If unavailable, consider project reconstruction
3. Set up proper development environment with Vite/React
4. Implement version control before any changes
5. Document all architectural decisions in ADRs
...
❌ **Don't modify dressmyrun.js** - Minified code, changes will be lost
❌ **Don't work without source code** - Impossible to maintain properly
❌ **Don't deploy without build process** - No way to compile changes
❌ **Don't reverse-engineer minified code** - Time-consuming and error-prone
❌ **Don't skip version control setup** - Critical for tracking changes
